...
class AuthRepository {
  ...
  // ── Inscription STAGIAIRE → compte créé directement ──────────
  ...
  // ── Inscription ENCADRANT → demande d'accès en attente ───────
  Future<Response> soumettreDemandeEncadrant({
    required String nom,
    ...
    try {
      return await _apiClient.dio.post(
        ...
        data: {
          ...
          "password": password,
          "telephone": telephone,
          "roleSouhaite": "ENCADRANT",
          "departement": departement,
          "specialite": specialite,
        },
      );
    } on DioException catch (e) {
      throw _handleDioError(e, context: "la demande d'accès");
    }
  }
